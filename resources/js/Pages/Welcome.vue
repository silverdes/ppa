...
<div class="flex flex-col items-top justify-center dark:bg-gray-900 sm:items-center sm:pt-0">
        <div class="w-full grid gap-3 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
              <div class="bg-white shadow-xl rounded-lg w-full">
                    ...
                    <div class="p-4">
                        <p class=" text-sm font-bold text-gray-700">Detached house • 5y old</p>
                    ...
                    <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
                        <div class="text-xs  font-bold text-gray-600">Realtor</div>
